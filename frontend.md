...
> После того, как вы реализовали задание - напишите в README о том, какие шаги нужно предпринять, чтобы добавить в систему событие "Запрос перевода", которое состоит из имени+счета запрашивающего, суммы запроса и даты. 
- Добавлять это событие не нужно - нужно только описать шаги для его добавления.
